...
$totalRows_persona = mysql_num_rows($persona);
 ...
 echo "<script type=\"text/javascript\">alert ('La cedula ya esta registrada');  location.href='consultar_personas_cedula2.php?cedula=$_POST[cedula]' </script>";
  exit;
}
  ...
  $Result1 = mysql_query($updateSQL, $consejo) or die(mysql_error());
    if($Result1){
  echo "<script type=\"text/javascript\">alert ('Datos Modificados');  location.href='consultar_personas_cedula2.php?cedula=$_POST[cedula]' </script>";
  }else{
